...
// kenytm
#import "../3rdParty/GraphicsServices/GSEvent.h"
...
// add calling private method (from veency http://gitweb.saurik.com/veency.git)
extern "C" {
...
static void postIOHIDEvent(IOHIDEventRef event){
    ...
    if ($IOHIDEventSetSenderID){
        ...
        ($IOHIDEventSetSenderID)(event, 0x8000000817319375);
    } else {
        ($IOHIDEventSetSenderID)(event, 0x0123456789ABCDEF);
    }
...
// unicode: ftp://ftp.unicode.org/Public/MAPPINGS/VENDORS/APPLE/CORPCHAR.TXT
// USB HID usage number(keycode): http://www.freebsddiary.org/APC/usb_hid_usages.php
static mapping specialMapping[] = {
    // {specialFunction, keyCode, charCode, modifier}
